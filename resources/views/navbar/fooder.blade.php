          ...
          <div class="col-sm-6 col-md-3">
            <div class="widget widget-brand">
              <div class="logo logo-footer">
                <h3>
                  <a href="{{route('main')}}">JM<span style="color:#7f8285;">Shop</span></a>
                </h3>
              </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <p class="copyright text-center">Copyright @2018 <a href="{{route('main')}}">JM<span style="color:#7f8285;">Shop</span></a></p>
          </div>
        </div>
      </div>
    </div>
